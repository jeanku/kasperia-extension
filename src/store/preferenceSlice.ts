...
const preferenceSlice = createSlice({
    ...
    reducers: {
        ...
        setNetwork: (state, action: PayloadAction<Network>) => {
            if (state.preference) {
                state.preference.network = action.payload;
            }
        },
        ...
        setKaspaTxList: (state, action: PayloadAction<Transaction[]>) => {
            if (state.preference) {
        ...
        setKasPrice: (state, action: PayloadAction<KasPrice>) => {
            if (state.preference) {
                state.preference.kasPrice = action.payload;
            }
        },
