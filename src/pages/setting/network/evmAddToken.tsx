...
const EvmAddToken = () => {
    ...
    return (
        <article className="page-box">
            ...
            <div className="content-main change-pwd mt15">
                ...
                <Button className="mb12" block loading={saveLoading} loadingText="Save..." color="primary" disabled={submitDisabled} onClick={submit}>
                    Save
                </Button>
            </div>
        </article>
