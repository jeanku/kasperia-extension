...
export class Keyring {
    ...
    static async addSubAccount(id: string): Promise<any> {
        return Chrome.request({ action: "Keyring.addSubAccount", id })
    }
    ...
    static async getAccountsSubListDisplay(): Promise<AccountsSubListDisplay[]> {
        return Chrome.request({ action: "Keyring.getAccountsSubListDisplay" })
    }
